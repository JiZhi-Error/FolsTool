...
public class XArrayList<E> extends AbstractList<E>  implements List<E>, RandomAccess, Cloneable, java.io.Serializable {  
    // 序列版本号  
	...
	public XArrayList arraycopy(int p2, java.lang.Object p3, int p4, int p5) {
		XArrays.arraycopy(elementData, p2, p3, p4, p5);
		return this;
	}
	public XArrayList arraycopyTraverse(int p2, java.lang.Object p3, int p4, int p5) {
    ...
    public Object clone() {  
        try {  
            XArrayList<E> v = (XArrayList<E>) super.clone();  
