...
public class XObjects {
	...
	public static String toString(Object... objArr) {
		if (isEmpty(objArr) || null == objArr[0])
			return null;
		if (objArr[0] instanceof String)
			...
			String codeing = (objArr.length <= 1 || !(objArr[1] instanceof String))
				? null
				: (String)objArr[1];
			return null == codeing
				? new String((byte[]) objArr[0]) 
				: new String((byte[]) objArr[0], Charset.forName(codeing));
		} else
