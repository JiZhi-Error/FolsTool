...
public class XCycleSpeedLimiter {
	...
	public XCycleSpeedLimiter(boolean isLimiter) {
		...
		this.averageSpeed.setCycleAverageSpeedUpdateCycle(XTimeTool.time_1s);
	}
	...
	private XCycleAverageSpeed averageSpeed = new XCycleAverageSpeed();
	public double getAverageSpeed() {
		return averageSpeed.getCycleAverageSpeed();
	}
	public long getAverageSpeedUpdateCycle() {
		return averageSpeed.getCycleAverageSpeedUpdateCycle();
	}
	public void setAverageSpeedUpdateCycle(long cycle) {
		averageSpeed.setCycleAverageSpeedUpdateCycle(cycle);
	}
