...
public class XCycleSpeedLimiter {
	...
	private static class SpeedLimiterInputStream<T extends InputStream> extends InputStream implements XInterfaceGetOriginStream<T>{
		private T stream;
	...
	private static class SpeedLimiterOutputStream<T extends OutputStream> extends OutputStream implements XInterfaceGetOriginStream<T>{
		private T stream;
		private XCycleSpeedLimiter m;
