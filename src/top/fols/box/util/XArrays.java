...
public class XArrays {
	public static class CharSequenceUtil {
		...
		public static char[] tocharArray(CharSequence originArray) {
			if (originArray == null) return XStaticFixedValue.nullcharArray;
	...
	public static byte[] tobyteArray(Object originArray) { return (byte[])XArray.copyOfConversion(originArray, XStaticBaseType.byte_class); }
	public static long[] tolongArray(Object originArray) { return (long[])XArray.copyOfConversion(originArray, XStaticBaseType.long_class); }
	public static double[] todoubleArray(Object originArray) { return (double[])XArray.copyOfConversion(originArray, XStaticBaseType.double_class); }
	public static char[] tocharArray(Object originArray) { return (char[])XArray.copyOfConversion(originArray, XStaticBaseType.char_class); }
	public static int[] tointArray(Object originArray) { return (int[])XArray.copyOfConversion(originArray, XStaticBaseType.int_class); }
	public static boolean[] tobooleanArray(Object originArray) { return (boolean[])XArray.copyOfConversion(originArray, XStaticBaseType.boolean_class); }
	public static float[] tofloatArray(Object originArray) { return (float[])XArray.copyOfConversion(originArray, XStaticBaseType.float_class); }
	public static short[] toshortArray(Object originArray) { return (short[])XArray.copyOfConversion(originArray, XStaticBaseType.short_class);}
	public static String[] toStringArray(Object originArray) { return (String[])XArray.copyOfConversion(originArray, XStaticBaseType.String_class); }
	public static Object[] toObjectArray(Object originArray) { return (Object[])XArray.copyOfConversion(originArray, XStaticBaseType.Object_class); }
}
