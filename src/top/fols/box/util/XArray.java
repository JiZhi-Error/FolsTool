...
public class XArray {
	...
	public static Class getElementClass(Class originalArrayCls) {
		return originalArrayCls.getComponentType();
	}
	 ...
	 */
	public static <A extends Object> A copyOfConversion(Object originalArray, A newArrayNullObj) {
		return copyOfConversion(originalArray, getLength(originalArray), newArrayNullObj);
	}
	public static <A extends Object> A copyOfConversion(Object originalArray, int length, A newArrayNullObj) {
