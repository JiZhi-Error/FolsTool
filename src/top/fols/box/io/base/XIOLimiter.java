...
public abstract class XIOLimiter {
	...
	public static List<String> keys() {synchronized (statico) {return listStatic.keys();}}
	public static void remove(String key) {synchronized (statico) {listStatic.remove(key);}}
	public static void clear(String key) {synchronized (statico) {listStatic.clear();}}
	public static int size() {synchronized (statico) {return listStatic.size();}}
