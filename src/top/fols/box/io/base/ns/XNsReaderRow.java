...
public class XNsReaderRow<T extends Reader> extends Reader implements  XInterfacePrivateBuffOperat<char[]>,XInterfaceLineReaderStream<char[]> ,XInterfereReleaseBufferable,XInterfaceGetOriginStream<T> {
	...
	private XNsCharArrayWriter rLReturnTmp = new XNsCharArrayWriter();
