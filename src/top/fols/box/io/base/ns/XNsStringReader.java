...
public class XNsStringReader extends Reader implements  XInterfacePrivateBuffOperat<String>,XInterfaceStreamLineReader<char[]>,XInterfacePrivateCharArrayBuffSearchOperat,XInterfacePrivateFixedStreamSizeOperat,XInterfacePrivateFixedStreamIndexOperat {
     ...
     */
    public XNsStringReader(String s) {
        this.str = s;
        this.count = s.length();
    }
	...
	public char[] readLine(char[] split, boolean resultAddSplitChar) {
		...
		if (pos >= count)
			return null;
		int index = XArrays2.indexOf(str, split, pos, count);
		if (index == -1) {
	...
	public int indexOfBuff(char b, int start) {
		return XArrays2. indexOf(str, b, start, size());
	}
	@Override
	public int indexOfBuff(char[] b, int start) {
		return XArrays2.indexOf(str, b, start, size());
	...
	public int indexOfBuff(char b, int start, int end) {
		return XArrays2.indexOf(str, b, start, end);
	}
	@Override
	public int indexOfBuff(char[] b, int start, int end) {
		return XArrays2.indexOf(str, b, start, end);
	...
	public int lastIndexOfBuff(char b, int start) {
		return XArrays2.lastIndexOf(str, b, 0, start);
	}
	@Override
	public int lastIndexOfBuff(char[] b, int start) {
		return XArrays2.lastIndexOf(str, b, 0, start);
	...
	public int lastIndexOfBuff(char b, int start, int end) {
		return XArrays2.lastIndexOf(str, b, start, end);
	}
	@Override
	public int lastIndexOfBuff(char[] b, int start, int end) {
		return XArrays2.lastIndexOf(str, b, start, end);
