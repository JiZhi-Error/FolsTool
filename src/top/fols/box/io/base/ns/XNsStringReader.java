...
public class XNsStringReader extends Reader implements  XInterfacePrivateBuffOperat<String>,XInterfaceLineReaderStream<char[]>,XInterfacePrivateCharArrayBuffSearchOperat,XInterfacePrivateFixedStreamIndexOperat,XInterfereReleaseBufferable {
    private String buf;
    private int count;
    private int pos = 0;
    private int mark = 0;
