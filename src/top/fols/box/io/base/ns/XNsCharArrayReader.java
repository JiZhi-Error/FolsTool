...
public class XNsCharArrayReader extends Reader implements  XInterfacePrivateBuffOperat<char[]>,XInterfaceLineReaderStream<char[]>,XInterfacePrivateCharArrayBuffSearchOperat,XInterfacePrivateFixedStreamIndexOperat, XInterfereReleaseBufferable{
	public int size() {
		return buf.length;
	}
	 ...
	 */
	public XNsCharArrayReader(char buf[]) {
		this.buf = buf;
		this.pos = 0;
	 ...
	 * 使用传入的buf构造CharArrayReader、并初始化CharArrayReader的buf、以及buf中将要被读取的字符的下标及总数。
	 */
	public XNsCharArrayReader(char buf[], int offset, int length) {
