 ...
 **/
public class XNsByteArrayOutputStream extends OutputStream implements  XInterfacePrivateBuffOperat<byte[]>,XInterfacePrivateByteArrayBuffSearchOperat,XInterfacePrivateFixedStreamSizeOperat,XInterfacePrivateFixedStreamIndexOperat,XReleaseBufferable {
	...
	private int count;  
	// 构造函数：默认创建的字节数组大小是32。  
	public XNsByteArrayOutputStream() {  
		this(32);  
	}  
	// 构造函数：创建指定数组大小的“字节数组输出流”  
	public XNsByteArrayOutputStream(int size) {  
		if (size < 0) {  
