...
public class XNsByteArrayInputStream extends InputStream implements XInterfacePrivateBuffOperat<byte[]>,XInterfaceLineReaderStream<byte[]>,XInterfacePrivateByteArrayBuffSearchOperat,XInterfacePrivateFixedStreamIndexOperat,XInterfereReleaseBufferable {
	// 保存字节输入流数据的字节数组
	private byte buf[];
	// 下一个会被读取的字节的索引
	private int pos;
