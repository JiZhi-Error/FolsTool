...
public class XInputStreamReaderLine<T extends XInterfaceRandomAccessInputStream> extends XInterfaceRandomAccessInputStream {
	private T stream;
	...
	public char[] readLine(boolean resultAddSplitChar) throws IOException {
		...
		return XEncoding.bytes2Chars((Array != null && Array.length == 0) ?null: Array, streamEncoding);
	}
