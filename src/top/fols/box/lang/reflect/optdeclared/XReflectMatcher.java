...
public class XReflectMatcher {
	...
	private static Constructor[] getConstructorsAll0(Class cls) { return XReflectAccessible.getConstructorsAllSetAccessibleTrue(cls); }
	private static Method[] getMethodsAll0(Class cls) { return XReflectAccessible.getMethodsAllSetAccessibleTrue(cls); }
	private static Method[] getMethodsAll0(Class cls, String name) { return XReflectAccessible.getMethodsAllSetAccessibleTrue(cls, name); }
	private static Field[] getFieldsAll0(Class cls) { return XReflectAccessible.getFieldsAllSetAccessibleTrue(cls); }
	...
	public static Object newInstance(Class cls, Object... paramInstanceArr) throws InvocationTargetException, InstantiationException, IllegalAccessException, IllegalArgumentException {
		Constructor con = matchConstructor(getConstructorsAll0(cls), paramInstanceArr);
		return con.newInstance(paramInstanceArr);
	}
	@XAnnotations("not cache option")
	public static Object newInstance(Object instance, Object... paramInstanceArr) throws InvocationTargetException, InstantiationException, IllegalAccessException, IllegalArgumentException {
		Constructor con = matchConstructor(getConstructorsAll0(instance.getClass()), paramInstanceArr);
		return con.newInstance(paramInstanceArr);
	}
	@XAnnotations("not cache option")
	public static Object execMethod(Class instanceCls, Object instance, String method, Object... paramInstanceArr) throws InvocationTargetException, IllegalAccessException, IllegalArgumentException {
		Method con = matchMethod(getMethodsAll0(instanceCls, method), paramInstanceArr);
		return con.invoke(instance, paramInstanceArr);
	}
	@XAnnotations("not cache option")
	public static Object execMethod(Object instance, String method, Object... paramInstanceArr) throws InvocationTargetException, IllegalAccessException, IllegalArgumentException {
		return execMethod(instance.getClass(), instance, method, paramInstanceArr);
	}
	@XAnnotations("not cache option")
	public static Object execStaticMethod(Class cls, String method, Object... paramInstanceArr) throws InvocationTargetException, IllegalAccessException, IllegalArgumentException {
		return execMethod(cls, null, method, paramInstanceArr);
	}
	@XAnnotations("not cache option")
	public static Object execStaticMethod(Object instance, String method, Object... paramInstanceArr) throws InvocationTargetException, IllegalAccessException, IllegalArgumentException {
