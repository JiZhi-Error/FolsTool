...
public class XReflectQuick {
	...
	public static class constructor {
		private Class cls;
		// cache
		private Map<ClassArrHash,Constructor> constructorHash = new HashMap<>(); //MethodName ->  ClassKey -> Method
		...
		public synchronized void setConstructors(Class cls, Constructor[] clsConstructors) {
			...
			Map<ClassArrHash, Constructor> newCache = new HashMap<>(); 
	...
	public static class method {
		...
		public synchronized void setMethods(Class cls, Method[] clsMethods) {
			...
			this.cls = cls;
			this.cache.clear();
			Map<String,Map<ClassArrHash,Method>> Hash = new HashMap<>(); 
