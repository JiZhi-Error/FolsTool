...
public class Main {
	public static void main(String[] args) {
		...
		try {
			...
			xioread.setCycleMaxSpeed(10 * 1024 * 1024);//限制 每个周期时间内 最多读18M 每个块8192
			xioread.setCycle(1000);
			...
			while (true) {
				...
				System.out.println("当前平均速度:" + XFileTool.fileUnitFormat(xioread.getAverageSpeed()) + "/S, Hs:" + st.end().getEndLessStart());
			}
...
//
			...
			String testUrl;
			testUrl = "http://tester:123456@www.baidu.com?/sb?a=b&b=c&c=d  #abc/";
			//testUrl = "http://127.0.0.1:7777/_HM4X/1qw/r/t/b";
			//testUrl = "http://127.0.0.1:7777?/post=4/_HM4X/1qw/r/t/b";

			XURL tsx = new XURL(testUrl);
			System.out.println(tsx);
			System.out.println(tsx.getParam());
...
//			
			...
			System.out.println(pa.getValueND("a"));
